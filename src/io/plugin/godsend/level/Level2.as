package io.plugin.godsend.level 
{
	...
	{
		[Embed(source='../../../../../lib/images/heightmap/hm2.png')]
		private var HeightMap: Class;
		
		[Embed(source = '../../../../../lib/images/heightmap/tm2.png')]
		...
		public function Level2() 
		{
			...
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( 90, 126, 35 ), "Fraser", "Blah...", null, 4.72, 0.4, 0.2, new TextureMaterial( myCharOne ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( 88, 124, 35 ), "Chris", "Blah...", null, 4.38, 0.2, 0.72, new TextureMaterial( myCharFive ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( 89, 91, 35 ), "Mike", "Blah...", null, 5.00, 0.3, 0.97, new TextureMaterial( myCharThree ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( 90, 93, 35 ), "Ty", "Blah...", null, 4.00, 0.1, 0.66, new TextureMaterial( myCharFour ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( 91, 89, 35 ), "Tyler", "Blah...", null, 3, 0.4, 0.51, new TextureMaterial( myCharTwo ) ));
			
			_exitPoint = new GeoSphere(13.75, 11, false, new FillMaterial(0xFFCC33, 0.3));
            _exitPoint.x = -88;
            _exitPoint.y = -63;
