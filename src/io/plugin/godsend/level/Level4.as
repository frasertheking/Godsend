package io.plugin.godsend.level 
{
	...
	{
		[Embed(source='../../../../../lib/images/heightmap/hm4.png')]
		private var HeightMap: Class;
		
		[Embed(source = '../../../../../lib/images/heightmap/tm4.png')]
		...
		public function Level4() 
		{
			...
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -185, -173, 35 ), "Fraser", "Blah...", null, 4.72, 0.4, 0.2, new TextureMaterial( myCharOne ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -183, -175, 35 ), "Chris", "Blah...", null, 4.38, 0.2, 0.72, new TextureMaterial( myCharFive ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -182, -178, 35 ), "Mike", "Blah...", null, 5.00, 0.3, 0.97, new TextureMaterial( myCharThree ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -181, -180, 35 ), "Ty", "Blah...", null, 4.00, 0.1, 0.66, new TextureMaterial( myCharFour ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -183, -172, 35 ), "Tyler", "Blah...", null, 3, 0.4, 0.51, new TextureMaterial( myCharTwo ) ));
