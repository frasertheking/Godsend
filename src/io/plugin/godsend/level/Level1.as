package io.plugin.godsend.level 
{
	...
	import io.plugin.godsend.assets.ValueBar;
	...
	{
		[Embed(source='../../../../../lib/images/heightmap/hm1.png')]
		private var HeightMap: Class;
		
		[Embed(source='../../../../../lib/images/heightmap/tm1.png')]
		...
		public var _escapeeList: Vector.<Escapee>
		...
		public function Level1() 
		{
			...
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -132.4, -142.8, 35 ), "Fraser", "Blah...", null, 4.72, 0.4, 0.2, new TextureMaterial ( myCharOne ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -133.9, -143.9, 35 ), "Chris", "Blah...", null, 4.38, 0.2, 0.72, new TextureMaterial ( myCharFive ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -131.1, -144.6, 35 ), "Mike", "Blah...", null, 5.00, 0.3, 0.97, new TextureMaterial ( myCharThree ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -129.8, -143.4, 35 ), "Ty", "Blah...", null, 4.00, 0.1, 0.66, new TextureMaterial ( myCharFour ) ));
			_escapeeList.push( new Escapee( 0.8, 1.4, new Vector3D( -133.2, -144.1, 35 ), "Tyler", "Blah...", null, 3, 0.4, 0.51, new TextureMaterial ( myCharTwo ) ));
			
			_exitPoint = new GeoSphere(13.75, 11, false, new FillMaterial(0xFFCC33, 0.15));
            _exitPoint.x = 127;
            _exitPoint.y = 85;
